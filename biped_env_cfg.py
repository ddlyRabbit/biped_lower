...
BIPED_CFG = ArticulationCfg(
    ...
    actuators={
        "hip_roll": DelayedPDActuatorCfg(
            ...
            stiffness=1000.0, damping=40.0, armature=0.015,
            friction=0.375,
        ...
        "hip_yaw": DelayedPDActuatorCfg(
            ...
            effort_limit=50.0, velocity_limit=10.0,
            stiffness=144.0, damping=3.0, armature=0.015,
            friction=0.375,
            min_delay=5, max_delay=10,
        ),
        "hip_pitch": DelayedPDActuatorCfg(
            ...
            stiffness=250.0, damping=6.5, armature=0.02,
            friction=0.5,
            min_delay=5, max_delay=10,
        ),
        "knee": DelayedPDActuatorCfg(
            ...
            effort_limit=100.0, velocity_limit=10.0,
            stiffness=144.0, damping=5.0, armature=0.02,
            friction=0.5,
            min_delay=5, max_delay=10,
        ),
