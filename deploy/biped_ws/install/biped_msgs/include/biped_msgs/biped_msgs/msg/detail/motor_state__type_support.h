...
#ifndef BIPED_MSGS__MSG__DETAIL__MOTOR_STATE__TYPE_SUPPORT_H_
#define BIPED_MSGS__MSG__DETAIL__MOTOR_STATE__TYPE_SUPPORT_H_
...
#endif  // BIPED_MSGS__MSG__DETAIL__MOTOR_STATE__TYPE_SUPPORT_H_
