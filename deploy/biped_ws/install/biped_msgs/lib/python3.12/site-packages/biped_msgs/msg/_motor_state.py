...
class MotorState(metaclass=Metaclass_MotorState):
    ...
    def __init__(self, **kwargs):
        ...
        self.mode_status = kwargs.get('mode_status', int())
    ...
    def __eq__(self, other):
        ...
        if self.fault_code != other.fault_code:
            return False
        if self.mode_status != other.mode_status:
            return False
        return True
    ...
    def mode_status(self):
        """Message field 'mode_status'."""
        return self._mode_status

    @mode_status.setter
    def mode_status(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'mode_status' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'mode_status' field must be an unsigned integer in [0, 255]"
