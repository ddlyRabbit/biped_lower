    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'biped_msgs.msg.MotorStateArray')
            logger.debug(
            ...
            from biped_msgs.msg import MotorState
...
class MotorStateArray(metaclass=Metaclass_MotorStateArray):
    ...
    _fields_and_field_types = {
        ...
        'motors': 'sequence<biped_msgs/MotorState>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['biped_msgs', 'msg'], 'MotorState')),  # noqa: E501
    )
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'motors' field must be a set or sequence and each value of type 'MotorState'"
        self._motors = value
