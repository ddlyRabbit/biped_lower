...
DEFAULT_GAINS = {
    "L_hip_pitch": (1.0, 0.1), "R_hip_pitch": (1.0, 0.1),
    "L_hip_roll":  (1.0, 0.1), "R_hip_roll":  (1.0, 0.1),
    "L_hip_yaw":   (1.0, 0.1), "R_hip_yaw":   (1.0, 0.1),
    "L_knee":      (1.0, 0.1), "R_knee":      (1.0, 0.1),
    "L_foot_pitch": (1.0, 0.1), "R_foot_pitch": (1.0, 0.1),
    "L_foot_roll":  (1.0, 0.1), "R_foot_roll":  (1.0, 0.1),
}
