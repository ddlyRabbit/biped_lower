"""State machine node — IDLE → STAND → WALK / SIM_WALK / WIGGLE_SEQ / WIGGLE_ALL / PLAY_TRAJ / PLAY_TRAJ_SIM → ESTOP.
...
class StateMachineNode(Node):
    ...
    def _command_cb(self, msg: String):
        ...
        elif cmd == "STOP" and self._state in ("WALK", "SIM_WALK", "WIGGLE_SEQ", "WIGGLE_ALL", "PLAY_TRAJ", "PLAY_TRAJ_SIM"):
            self._transition("STAND")
